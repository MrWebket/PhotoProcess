...
public class IFImageFilter extends GPUImageFilter {
	...
	public void onInit() {
		super.onInit();
		filterInputTextureUniform2 = GLES20.glGetUniformLocation(getProgram(),
				"inputImageTexture2");
		filterInputTextureUniform3 = GLES20.glGetUniformLocation(getProgram(),
				"inputImageTexture3");
		filterInputTextureUniform4 = GLES20.glGetUniformLocation(getProgram(),
				"inputImageTexture4");
		filterInputTextureUniform5 = GLES20.glGetUniformLocation(getProgram(),
				"inputImageTexture5");
		filterInputTextureUniform6 = GLES20.glGetUniformLocation(getProgram(),
				"inputImageTexture6");
	...
	public void initInputTexture() {
			...
			runOnDraw(new Runnable() {
				...
				public void run() {
					Bitmap b = BitmapFactory.decodeResource(
							mContext.getResources(), mResIds.get(0));
					filterSourceTexture2 = OpenGlUtils.loadTexture(b,
		...
		if (mResIds.size() > 1) {
			runOnDraw(new Runnable() {
				...
				public void run() {
					Bitmap b = BitmapFactory.decodeResource(
							mContext.getResources(), mResIds.get(1));
					filterSourceTexture3 = OpenGlUtils.loadTexture(b,
							OpenGlUtils.NO_TEXTURE, true);
				}
			});
		}
		...
		if (mResIds.size() > 2) {
			runOnDraw(new Runnable() {
				...
				public void run() {
					Bitmap b = BitmapFactory.decodeResource(
							mContext.getResources(), mResIds.get(2));
					filterSourceTexture4 = OpenGlUtils.loadTexture(b,
							OpenGlUtils.NO_TEXTURE, true);
				}
			});
		}
		...
		if (mResIds.size() > 3) {
			runOnDraw(new Runnable() {
				...
				public void run() {
					Bitmap b = BitmapFactory.decodeResource(
							mContext.getResources(), mResIds.get(3));
					filterSourceTexture5 = OpenGlUtils.loadTexture(b,
							OpenGlUtils.NO_TEXTURE, true);
				}
			});
		}
		...
		if (mResIds.size() > 4) {
			runOnDraw(new Runnable() {
				...
				public void run() {
					Bitmap b = BitmapFactory.decodeResource(
							mContext.getResources(), mResIds.get(4));
					filterSourceTexture6 = OpenGlUtils.loadTexture(b,
							OpenGlUtils.NO_TEXTURE, true);
				}
			});
		}
