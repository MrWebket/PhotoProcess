package com.hope.photoprocess.widget.ImageViewTouch;
...
import com.hope.photoprocess.widget.ImageViewTouch.easing.Cubic;
import com.hope.photoprocess.widget.ImageViewTouch.easing.Easing;
import com.hope.photoprocess.widget.ImageViewTouch.graphics.FastBitmapDrawable;
import com.hope.photoprocess.widget.ImageViewTouch.utils.IDisposable;
        ...
        if (drawable != null) {
            ...
            if (changed || mScaleTypeChanged || mBitmapChanged) {
                ...
                if (mBitmapChanged || mScaleTypeChanged) {
                    ...
                    if (LOG_ENABLED) {
                        Log.d(LOG_TAG, "display holderType: " + mScaleType);
